...
import {
  ...
  SiSpringboot, SiSymfony, SiOpenai,
} from "react-icons/si";
...
export default function About() {
  ...
  const skills = [
    ...
    {id:25, name: "Spring Boot", icon: <SiSpringboot color="#6DB33F" /> },
    {id:26, name: "Symfony", icon: <SiSymfony color="#000000" /> },
    {id:27, name: "n8n", icon: <SiN8N color="#EA4B71" /> },
    {id:28, name: "AI Tools", icon: <SiOpenai color="#412991" /> },
  ];
