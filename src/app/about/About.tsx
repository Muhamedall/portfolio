...
const skillCategories = [
  ...
  },
  {
    ...
    dot: "bg-green-400",
    skills: [
      { id: 1, name: "Node.js", icon: <FaNodeJs color="#339933" /> },
      { id: 2, name: "Express.js", icon: <SiExpress color="#e5e5e5" /> },
      { id: 3, name: "Python", icon: <FaPython color="#306998" /> },
      { id: 4, name: "Laravel", icon: <FaLaravel color="#FF2D20" /> },
      { id: 5, name: "PHP", icon: <SiPhp color="#777BB4" /> },
      { id: 6, name: "Java", icon: <FaJava color="#007396" /> },
      { id: 7, name: "Spring Boot", icon: <SiSpringboot color="#6DB33F" /> },
      { id: 8, name: "Symfony", icon: <SiSymfony color="#e5e5e5" /> },
    ],
  },
  {
    id: "database",
